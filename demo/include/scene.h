...
/// @brief A render instance is a rendering ready representation of a SceneNode.
...
public:
	...
	/// @brief Retrieve cached instance data generated by the latest call to SceneGraph::generateInstanceData.
	/// @return Cached instance data.
	const std::vector<RenderInstance>& getInstanceData() const;

	/// @brief Generate instance data based on camera position, calculating LOD levels & returning an instance list.
